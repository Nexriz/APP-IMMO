...
INSERT INTO "new_User" ("Role", "createdAt", "email", "emailVerified", "id", "image", "name", "password") SELECT "Role", "createdAt", "email", "emailVerified", "id", "image", "name", "password" FROM "User";
DROP TABLE "User";
